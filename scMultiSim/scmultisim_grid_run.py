...
if __name__=="__main__":
	...
	grid = {"diff_cif_fraction": [.1, .3, .5, .7, .9], 
		"cif_sigma": [.1, .3, .5, .7, .9]}	
	data_path = ...
	early_cell = #identify initial cell
	terminal_states = #identify terminal cells 
	...
	for values in itertools.product(*grid.values()):
		...
		save_multiomics = os.path.join(os.getcwd(), "results", f"{diff_cif_fraction}_{cif_sigma}_multiomics")
		save_rna = os.path.join(os.getcwd(), "results", f"{diff_cif_fraction}_{cif_sigma}_rna")	
