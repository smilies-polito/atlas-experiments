...
if __name__=="__main__":
	...
	tm = TransitionMatrix(data, modality_key="rna", rna_key = "rna", atac_key="activity", velocity_key="velocity")
	tm.compute_transition_matrix(key="connectivities")
	transition_matrix = tm.transition_matrix

	analyser = MatrixAnalyser(transition_matrix, data["rna"], cluster_key="pop", seed = seed)
	...
	gpcca.compute_fate_probabilities(tol = 1e-6, use_petsc=True, preconditioner = "ilu")
