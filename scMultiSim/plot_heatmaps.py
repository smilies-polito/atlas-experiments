...
if __name__=="__main__":
	...
	pearson_kl_terminal = {"diff_cif_fraction":[], "sigma_cif":[], "statistic":[], "pvalue":[]}
	kendall_kl_terminal = {"diff_cif_fraction":[], "sigma_cif":[], "statistic":[], "pvalue":[]}
	pearson_kl = {"diff_cif_fraction":[], "sigma_cif":[], "statistic":[], "pvalue":[]}
	kendall_kl = {"diff_cif_fraction":[], "sigma_cif":[], "statistic":[], "pvalue":[]}
	...
	for diff_cif_fraction, sigma_cif in product(*grid.values()):
		...
		fill_with_results(pearson_entropy_terminal, diff_cif_fraction, sigma_cif, (results["si_terminal"]["spearman_entropy"]["statistics"], results["si_terminal"]["spearman_entropy"]["pvalue"]), has_pvalue=True)
		fill_with_results(pearson_entropy, diff_cif_fraction, sigma_cif, (results["no_terminal"]["spearman_entropy"]["statistics"], results["no_terminal"]["spearman_entropy"]["pvalue"]), has_pvalue=True)
		...
		fill_with_results(pearson_kl_terminal, diff_cif_fraction, sigma_cif, (results["si_terminal"]["spearman_KL"]["statistics"], results["si_terminal"]["spearman_KL"]["pvalue"]), has_pvalue=True)
		fill_with_results(pearson_kl, diff_cif_fraction, sigma_cif, (results["no_terminal"]["spearman_KL"]["statistics"], results["no_terminal"]["spearman_KL"]["pvalue"]), has_pvalue=True)
		fill_with_results(kendall_kl_terminal, diff_cif_fraction, sigma_cif, (results["si_terminal"]["kendall-tau_KL"]["statistics"], results["si_terminal"]["kendall-tau_KL"]["pvalue"]), has_pvalue=True)
		fill_with_results(kendall_kl, diff_cif_fraction, sigma_cif, (results["no_terminal"]["kendall-tau_KL"]["statistics"], results["no_terminal"]["kendall-tau_KL"]["pvalue"]), has_pvalue=True)
	...
	pearson_kl_terminal = pd.DataFrame(pearson_kl_terminal)	
	pearson_kl = pd.DataFrame(pearson_kl)	
	kendall_kl_terminal = pd.DataFrame(kendall_kl_terminal)	
	kendall_kl = pd.DataFrame(kendall_kl)
	...
	kwargs = {"title": "Euclidean Similarity Branch:61", "cmap_label": "f1_score", "cmap_range": (-10, 10), "xlabel":"sigma_cif", "ylabel":"rd"} 
	...
	kwargs = {"title": "Pearson Correlation True Pseudotime - KL-divergence", "cmap_label": "correlation", "cmap_range": (-1, 1), "xlabel":"sigma_cif", "ylabel":"rd"} 
	plot_heatmap(pearson_kl_terminal, has_pvalue=True, saving_path = os.path.join(os.getcwd(), "results", f"{model}_pearson_kl_terminal.png"), **kwargs)
	plot_heatmap(pearson_kl, has_pvalue=True, saving_path = os.path.join(os.getcwd(), "results", f"{model}_pearson_kl.png"), **kwargs)


	kwargs = {"title": "Kendall-Tau Correlation True Pseudotime - KL-divergence", "cmap_label": "correlation", "cmap_range": (-1, 1), "xlabel":"sigma_cif", "ylabel":"rd"} 
	plot_heatmap(kendall_kl_terminal, has_pvalue=True, saving_path = os.path.join(os.getcwd(), "results", f"{model}_kendall_kl_terminal.png"), **kwargs)
	plot_heatmap(kendall_kl, has_pvalue=True, saving_path = os.path.join(os.getcwd(), "results", f"{model}_kendall_kl.png"), **kwargs)
