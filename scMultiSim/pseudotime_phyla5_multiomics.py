...
if __name__=="__main__":
	...
	for diff_cif_fraction, sigma_cif, knn_rna, knn_atac, wnn in product(*grid_scmultisim.values()):	
		...
		saving_folder = os.path.join(os.getcwd(), "pseudotime_phyla5_multiomics", f"{diff_cif_fraction}_{sigma_cif}_{knn_rna}{knn_atac}{wnn}_rna")
