...
if __name__=="__main__":
	...
	sc.pl.embedding(data, basis="X_umap", color = ["is_starting"], palette="PuRd", show=False, save="intial_cells.png", title="starting cells")
...
#	plt.show()
	...
	sc.pl.embedding(data, basis="X_umap", color = ["is_terminal"], palette = "PuRd", show=False, save="terminal_states.png", title="ending_cells")
