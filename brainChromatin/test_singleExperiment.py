...
if __name__=="__main__":
	...
	data = mu.read_h5mu(os.path.join(os.getcwd(), experiment, "data.h5mu"))
	annotations = pd.read_csv(os.path.join(os.getcwd(), experiment, "promoter_annotations.tsv"), sep="\t", header=0, index_col=0)
	...
	kernel.plot_random_walks(start_ixs = start_ixs, n_sims = 2000, seed=seed, save = f"rw_{experiment}.png")
