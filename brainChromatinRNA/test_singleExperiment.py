...
if __name__=="__main__":
	...
	data = sc.read_h5ad(os.path.join(os.getcwd(), experiment, "rna", "data.h5ad"))

	kernel = cr.kernels.VelocityKernel(data)
	kernel.compute_transition_matrix()
	start_ixs = data.obs[data.obs["Cluster.Name"]=="RG"].index
