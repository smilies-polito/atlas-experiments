...
if __name__=="__main__":
	data_path = ...
	data = mu.read_h5mu(os.path.join(data_path, "mofa.h5mu"))
	...
	#MOFA run 		
	pw.compute_kernel(data, knn_key="neighbors", distance_key="distances")
	...
	pc.linear_model(data, data["rna"], "rna:celltype", save=True, saving_path = os.path.join(saving_path, "fates"), model1="mofa")
	pc.linear_model(data, data["rna"], "rna:celltype", is_fate=False, save=True, saving_path = os.path.join(saving_path, "entropy"), key1="palantir_entropy", key2="palantir_entropy", model1="mofa")
	pc.plot_probability_distribution(data, data["rna"], "rna:celltype", saving_path = os.path.join(saving_path, "fates"), model1="mofa")	
	pc.plot_entropy_distribution(data, data["rna"], "rna:celltype", saving_path = os.path.join(saving_path, "entropy"), model1="mofa")
