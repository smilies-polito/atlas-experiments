...
if __name__=="__main__":
	...
	macrostates_to_eval = list(range(3,10,2))
	...
	try:
		...
		for n_macrostates in macrostates_to_eval:
			...
			g.plot_macrostate_composition(key="celltype", show=False, save=os.path.join(results_folder, plot_path), title=title)
			...
			g.plot_fate_probabilities(same_plot=True, save=os.path.join(results_folder, plot_path), title=title, show=False, color="celltype")
