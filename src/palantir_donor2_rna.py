...
if __name__=="__main__":
	...
	plot_heatmap(data=data["rna"], similarity_key="DM_Similarity", group_key="STD.CellType", subset_key=None, keep_subset=None, save=os.path.join(saving_folder, "similarity_celltypes.png"))
	plot_heatmap(data=data["rna"], similarity_key="DM_EigenVectors_multiscaled", group_key="STD.CellType", subset_key=None, keep_subset=None, save=os.path.join(saving_folder, "diffusion_space_celltypes.png"))
